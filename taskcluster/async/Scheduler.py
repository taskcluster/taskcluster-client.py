...
class Scheduler(AsyncClient):
    ...
    async def createTaskGraph(self, taskGraphId, payload):
        '''
    ...
    async def extendTaskGraph(self, taskGraphId, payload):
        '''
    ...
    async def status(self, taskGraphId):
        '''
        Task Graph Status
    ...
    async def info(self, taskGraphId):
        '''
    ...
    async def inspect(self, taskGraphId):
        '''
        Inspect Task Graph
    ...
    async def inspectTask(self, taskGraphId, taskId):
        '''
